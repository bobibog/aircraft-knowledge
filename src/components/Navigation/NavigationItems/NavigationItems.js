...
const navigationItems = ( props ) => (
    ...
    // console.log("ROLE "+props.isRole),
        ...
        {(props.isAuthenticated ) ? <NavigationItem link="/airports">Airports</NavigationItem> : null}       
         {(props.isAuthenticated && props.isParser || props.isAuthenticated && props.isRole || props.isAuthenticated && !props.isCustomer) ? <NavigationItem link="/aircraft">Aircraft</NavigationItem> : null}
        
         {(props.isAuthenticated && props.isParser || props.isAuthenticated && props.isRole || props.isAuthenticated && !props.isCustomer) ? <NavigationItem link="/airlines">Airlines</NavigationItem> : null}
        ...
        {(props.isAuthenticated && props.isParser || props.isAuthenticated && props.isRole || props.isAuthenticated && !props.isCustomer) ? <NavigationItem link="/statistics">Statistics</NavigationItem> : null}
