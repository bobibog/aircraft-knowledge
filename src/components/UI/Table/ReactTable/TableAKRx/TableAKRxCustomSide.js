...
const TableAKRx = (props) => {
    ...
    return (
       ...
       <table {...getTableProps()} >
        ...
        : <div style={{ marginTop:"95px" }}><p style={{ color:"red", fontSize:"26px" }}>There are no data for 
        entered serach term. Please back to previous page or enter new search term in the Filter.</p></div>}
